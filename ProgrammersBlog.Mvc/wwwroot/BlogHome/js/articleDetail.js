        ...
        $(document).on('click', '#btnSave', function (event) {
            ...
            $.post(actionUrl, dataToSend).done(function (data) {
                ...
                if (isValid) {
                    ...
                    //            <img class="d-flex mr-3 rounded-circle" src="~/img/userImages/commentUser.png" alt="">
                    ...
                    toastr.success(`Sayın ${commentAddAjaxModel.CommentDto.Comment.CreatedByName} yorumunuz başarıyla eklenmiştir. Yorumunuz onaylandıktan sonra görünür olacaktır.`);
