...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Add(CategoryAddDto categoryAddDto)
        {
            ...
            {
                var result = await _categoryService.Add(categoryAddDto, "Cantürk Ataş");
        ...
        public async Task<IActionResult> Update(CategoryUpdateDto categoryUpdateDto)
        {
            if (ModelState.IsValid)
            {
                var result = await _categoryService.Update(categoryUpdateDto, "Cantürk Ataş");
                if (result.ResultStatus == ResultStatus.Success)
                {
        ...
        {
            var result = await _categoryService.Delete(categoryId, "Cantürk Ataş");
